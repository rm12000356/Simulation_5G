...
## this code need the addition to OFDM  for multiple channels
# also the pilot creation resorces alocation and channel estiation parts
# data - crc - polar encode - modulate - ofdm (needs to be added)- channel (only AWGN) need to add Rice or rayleigh- ofdm demod (needs to be added) - demodulate (llrs)- polar decode - crc check (only check no correction is done)- data
